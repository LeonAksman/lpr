...
% $Id: prt_cfg_model.m 741 2013-07-22 14:07:36Z mjrosa $
...
k_args.help    = {['Number of folds/partitions for CV. To create a 50%-50%,' ...
    'choose k as 1 (first half as train, last half as test. Please note that '...
    'leaving more than 50% of the data out is not permitted. k=0 corresponds ' ...
    'to leave-one-out.']};
k_args.strtype = 'e';
k_args.num     = [1 1];
