%    Demo of an analysis using LTC-PCA, using all (3+) scans from each subject to build projection
...
%
function metrics                        = demo_ltcpca(runMode, logFilename) 
...
in.analysisName                         = 'OASIS LTC-PCA (all TPs)';
