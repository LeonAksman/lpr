%    Demo of an analysis using unbalanced LM-PCA, with long intervals between scans
...
%
function metrics                        = demo_lmpca_long(runMode, logFilename) 
...
in.analysisName                         = 'OASIS LM-PCA (long)';
...
in.algo.input.samplesChosen                 = 'firstLast';                        	%how many samples to use from each subject - 'all'/'lastTwo'/'firstLast' 
